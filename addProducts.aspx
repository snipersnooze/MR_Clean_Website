<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="addProducts.aspx.cs" Inherits="MR_CLEAN_FINAL.addProducts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="login-html">
		<input id="tab-1" type="text" name="tab" class="sign-up"><label for="tab-1" class="tab">Add a Product</label>
			...
			<div>
             ...
             <label for="PCAT">Product Category:</label>
				...
				<div class="group" >
					...
					<input id="ProdQTY"  type="text" class="input" runat="server" required>
				</div>

				<div class="group" runat="server">
				<asp:Button type="submit" class="button" ID="btnAddProduct" runat="server" Text="Add" OnClick="btnSignUp_Click" />
				</div>

				<div class="hr"></div>
			<label id="AddStatus" runat="server"  style="color:black; font-size:22px;" hidden>New Product Added</label>
