<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="addUser.aspx.cs" Inherits="MR_CLEAN_FINAL.addUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="login-html">
		<input id="tab-1" type="text" name="tab" class="sign-up"><label for="tab-1" class="tab">Add a User</label>
		...
		<div class="login-form">
			...
			<div >
             ...
             <label for="users">Choose a user type:</label>
                <select name="users" id="usertype" runat="server">
                 <option value="CUS">Customer</option>
                <option value="MAN">Manger</option>
				...
				<div class="hr"></div>
			<label id="regstatus" runat="server"  style="color:black; font-size:22px;" hidden>New User added</label>
